...
CACHE_FILE = "data_analysis/data/t_lookahead.pkl"
LOAD_FILE = True
...
file1 = "output/synthetic/15ac_1/flight_output.csv"
file2 = "output/synthetic/35ac_1/flight_output.csv"
file3 = "output/synthetic/65ac_1/flight_output.csv"
...
reference = (
    df_results.loc[df_results['T-Lookahead'] == 1000, ['Density', 'Conflicts']]
    .rename(columns={'Conflicts': 'conflict_at_1000'})
)

df_results = df_results.merge(reference, on='Density', how='left')

df_results['Conflict Percentage'] = 100 * df_results['Conflicts'] / df_results['conflict_at_1000']
...
plt.xlabel("Lookahead Time (s)")
plt.ylabel("Percentage of conflicts remaining")
